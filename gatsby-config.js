module.exports = {
  ...
  siteMetadata: {
    ...
    education: [
      {
        name:
          'Technical University of Munich: M.Sc. Computer Science (expected: 2021)',
        description:
          'Focus on software engineering, data science and efficient algorithms',
      },
      {
        name:
          'Technical University of Munich: B.Sc. Computer Science: Games Engineering',
        description:
          'Projects with game development technologies (Unity3D, Android, Java, C++, DirectX, C)',
      },
    ],
    projects: [
      {
    ...
    experience: [
      {
        ...
        description:
          'Backend Software Engineer Working Student, May 2019 - present',
      ...
      },
      {
        name: 'CQSE GmbH',
        description:
          'Full-Stack Development Working Student & Bachelor Thesis, November 2018 - May 2019',
    ...
    education: [
      {
        name:
          'Technical University of Munich: M.Sc. Computer Science (expected: 2022)',
        description:
          'Focus on software engineering, data science and efficient algorithms',
      },
      {
